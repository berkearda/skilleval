  ...
  return (
    ...
    >
      ...
      >
          ...
          <div>
            ...
            {lead ? (
              <p className="mt-1 text-sm text-muted-foreground">
                {models[0].name} leads on {lead.aWins} of{' '}
                {orderedSkills.length} skills, {models[1].name} on{' '}
                {lead.bWins}.
              </p>
            ) : null}
          </div>
        ...
        {/* fingerprints */}
        <div className="mt-5 grid gap-4" style={{ gridTemplateColumns: `repeat(${models.length}, 1fr)` }}>
          {models.map((m, i) => (
            <div
              key={m.id}
